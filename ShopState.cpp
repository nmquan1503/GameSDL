...
void ShopState::render()
{
    ...
    ManageTexture::GetInstance()->draw("gold_data",5,245,150,50,Game::GetInstance()->GetRenderer(),true);
    ManageTexture::GetInstance()->draw("gem_data",5,305,150,50,Game::GetInstance()->GetRenderer(),true);
